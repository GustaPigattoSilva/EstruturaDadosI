...
Page pageFifth = new Page () {Content = "Enquanto..."};
Page pageSixth = new Page () {Content = "Você poderia..."};

/* Page pageFifht = new Page () {
    Content = "Enquanto...",
    PageNumber = 5
};
...
while (current !=null)
{
    ...
    int leadingSpaces = (90 - numberString.PadLeft (leadingSpaces
        + numberString.Length));
    Console.WriteLine();

    string content = current.Value.Content;
    for (int i - 0; i < content.Length; if += 90)
    {
